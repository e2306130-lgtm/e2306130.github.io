...
// HTML側からプレイヤーの手を受け取って、ランダムに手を選択したコンピュータとじゃんけんする
function janken(myHand){
// 必要となる変数の整理
// じゃんけんの手を格納する変数を用意
let handArrey = ["グー","チョキ","パー"];

// じゃんけんの結果の文字列を格納する変数を用意
let resultArrey = ["あいこです","あなたの負けです","あなたの勝ちです"];
...
// プレイヤーの手を決定
// HTML側で選択されたものを使う
console.log("あなたの手は：" + handArrey[myHand]);

// コンピュータの手を決定
// ランダムに手を決めたい
// Math.random（）：０以上1未満の疑似乱数分布の中から一つ値を取得する
let rand = Math.random() * 100;
console.log("乱数：" + rand);

// 乱数を整数に
// Math.floor：与えられた引数以下の最大の整数を表す
